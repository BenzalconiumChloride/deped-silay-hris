...
<div class="card shadow">
    <div class="card-header d-flex justify-content-between align-items-center">
        ...
        <div>
            <a href="index.php?view=edit&id=<?php echo $employee['employee_id'] ?? ''; ?>"
    ...
    <div class="card-body">
        <div class="row">
            <div class="col-md-3 text-center mb-4">
                <div class="mb-3">
                    <?php if (!empty($employee['photo_path']) && file_exists(SRV_ROOT . 'assets/uploads/' . $employee['photo_path'])): ?>
                        <img src="<?php echo WEB_ROOT . 'assets/uploads/' . $employee['photo_path']; ?>"
                ...
                <div class="tab-content border border-top-0 p-4 rounded-bottom" id="myTabContent">
                    ...
                    <div class="tab-pane fade show active" id="personal" role="tabpanel">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-8">
                                <?php echo htmlspecialchars($employee['gender'] ?? 'N/A'); ?>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-md-4 fw-bold">Civil Status</div>
                            <div class="col-md-8">
                                <?php echo htmlspecialchars($employee['civil_status'] ?? 'N/A'); ?>
                            </div>
                        </div>
                        <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-8">
                                <?php echo htmlspecialchars($employee['birth_place'] ?? 'N/A'); ?>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="tab-pane fade" id="employment" role="tabpanel">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-8">SG
                                <?php echo htmlspecialchars($employee['salary_grade'] ?? 'N/A'); ?> / Step
                                <?php echo htmlspecialchars($employee['step_increment'] ?? 'N/A'); ?>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-md-4 fw-bold">Monthly Salary</div>
                            <div class="col-md-8">
                                <?php echo formatCurrency($employee['monthly_salary'] ?? 0); ?>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-md-4 fw-bold">Employee Type</div>
                            <div class="col-md-8">
                                <?php echo htmlspecialchars($employee['employee_type'] ?? 'N/A'); ?>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-md-4 fw-bold">School Assignment</div>
                            <div class="col-md-8">
                                <?php echo htmlspecialchars($employee['school_assignment'] ?? 'N/A'); ?>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-md-4 fw-bold">School ID</div>
                            <div class="col-md-8">
                                <?php echo htmlspecialchars($employee['school_id'] ?? 'N/A'); ?>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-md-4 fw-bold">Division</div>
                            <div class="col-md-8">
                                <?php echo htmlspecialchars($employee['division'] ?? 'N/A'); ?>
                            </div>
                        </div>
                        <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-8">
                                <?php echo htmlspecialchars($employee['bank_name'] ?? 'N/A'); ?><br>
                                Account:
                    ...
                    <div class="tab-pane fade" id="contact" role="tabpanel">
                        <div class="row mb-3">
                            ...
                            <div class="col-md-8">
                                <?php echo htmlspecialchars($employee['email_official'] ?? 'N/A'); ?>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-md-4 fw-bold">Personal Email</div>
                            <div class="col-md-8">
                                <?php echo htmlspecialchars($employee['email_personal'] ?? 'N/A'); ?>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-md-4 fw-bold">Mobile Number</div>
                            <div class="col-md-8">
                                <?php echo htmlspecialchars($employee['mobile_number'] ?? 'N/A'); ?>
                            </div>
                        </div>
                        <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-8">
                                <?php echo htmlspecialchars($employee['emergency_person'] ?? 'N/A'); ?> (
                                <?php echo htmlspecialchars($employee['emergency_relationship'] ?? 'N/A'); ?>)
                            </div>
                        </div>
                        <div class="row mb-3">
