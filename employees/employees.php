            ...
            <div class="row">
                ...
                <div class="col-md-4 mb-3">
                    <select name="status" class="form-control">
                        ...
                        <option value="Retired" <?php echo $status_filter == 'Retired' ? 'selected' : ''; ?>>Retired
                        </option>
                        <option value="On-Leave" <?php echo $status_filter == 'On-Leave' ? 'selected' : ''; ?>>On-Leave
                        </option>
                        <option value="Resigned" <?php echo $status_filter == 'Resigned' ? 'selected' : ''; ?>>Resigned
                        </option>
                    </select>
                </div>
                    ...
                    <?php foreach ($employees as $employee): ?>
                        ...
                        <tr>
                            <td>
                                ...
                                <small class="text-muted">DepEd:
                                    <?php echo htmlspecialchars($employee['deped_id'] ?? ''); ?></small>
                            </td>
                            <td>
                                <strong><?php echo htmlspecialchars(($employee['last_name'] ?? '') . ', ' . ($employee['first_name'] ?? '') . ' ' . ($employee['middle_name'] ?? '')); ?></strong><br>
                                <small
                                    class="text-muted"><?php echo htmlspecialchars($employee['email_official'] ?? ''); ?></small>
                            </td>
                            ...
                            <td>
                                <div class="btn-group" role="group">
                                    <a href="index.php?view=view&id=<?php echo $employee['employee_id'] ?? ''; ?>"
