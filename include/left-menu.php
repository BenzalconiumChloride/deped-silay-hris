<div class="sidebar-header">
    <div>
        <img src="<?php echo WEB_ROOT; ?>assets/images/depedSilay.png" class="logo-icon" alt="logo icon">
    </div>
    <div>
...
<ul class="metismenu" id="menu">
    ...
    <li>
        <a href="<?php echo WEB_ROOT; ?>retirements/">
            <div class="parent-icon"><i class='bx bx-user'></i>
            </div>
            <div class="menu-title">Retirements</div>
        </a>
    </li>
    <li>
